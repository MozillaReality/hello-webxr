...
export default {
  ...
  controller_tex: { url: 'controller.png' },
  doorfx_tex: { url: 'doorfx.png', options: { wrapT: THREE.RepeatWrapping, wrapS: THREE.RepeatWrapping }},
  sky_tex: { url: 'sky.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  clouds_tex: { url: 'clouds.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  teleport_model: { url: 'teleport.glb' },
  beam_tex: { url: 'beamfx.png' },
  glow_tex: { url: 'glow.png', options: { encoding: THREE.sRGBEncoding} },
  newsticker_tex: { url: 'newsticker.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  mozillamr_tex: { url: 'mozillamr.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  zoomicon_tex: { url: 'zoomicon.png' },

  // panoramas
  panoballfx_tex: { url: 'ballfx.jpg', options: { wrapT: THREE.RepeatWrapping, wrapS: THREE.RepeatWrapping } },
  ...
  pano1small: { url: 'stereopano_small.jpg', options: {encoding: THREE.sRGBEncoding} },
  ...
  pano2small: { url: 'tigerturtle_small.png', options: {encoding: THREE.sRGBEncoding} },
  pano3small: { url: 'lakebyllesby_small.png', options: {encoding: THREE.sRGBEncoding} },
  pano4small: { url: 'haldezollern_small.png', options: {encoding: THREE.sRGBEncoding} },
  pano5small: { url: 'zapporthorn_small.png', options: {encoding: THREE.sRGBEncoding} },
  pano6small: { url: 'thuringen_small.png', options: {encoding: THREE.sRGBEncoding} },

  // graffiti
  spray_model: { url: 'spray.glb' },
  spray_tex: { url: 'spray.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },

  // vertigo
  vertigo_model: { url: 'vertigo.glb' },
  vertigo_door_lm_tex: { url: 'vertigo_door_lm.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  ...
  sound_door_lm_tex: { url: 'sound_door_lm.png', options: { wrapT: THREE.RepeatWrapping, wrapS: THREE.RepeatWrapping} },
  grid_tex: { url: 'grid.png' },

  // photogrammetry object
  pg_floor_tex: { url: 'travertine2.jpg', options: { encoding: THREE.sRGBEncoding, flipY: false, wrapT: THREE.RepeatWrapping, wrapS: THREE.RepeatWrapping} },
  pg_floor_lm_tex: { url: 'pg_floor_lm.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  pg_door_lm_tex: { url: 'pg_door_lm.png', options: { encoding: THREE.sRGBEncoding, flipY: false} },
  ...
  pg_panel_tex: { url: 'panel.jpg', options: { encoding: THREE.sRGBEncoding, flipY: false} },
